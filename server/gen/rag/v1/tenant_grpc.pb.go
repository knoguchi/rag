...
const (
	TenantService_CreateTenant_FullMethodName     = "/rag.v1.TenantService/CreateTenant"
	TenantService_GetTenant_FullMethodName        = "/rag.v1.TenantService/GetTenant"
	TenantService_ListTenants_FullMethodName      = "/rag.v1.TenantService/ListTenants"
...
func (c *tenantServiceClient) RegenerateAPIKey(ctx context.Context, in *RegenerateAPIKeyRequest, opts ...grpc.CallOption) (*RegenerateAPIKeyResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RegenerateAPIKeyResponse)
	err := c.cc.Invoke(ctx, TenantService_RegenerateAPIKey_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _TenantService_RegenerateAPIKey_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RegenerateAPIKeyRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TenantServiceServer).RegenerateAPIKey(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TenantService_RegenerateAPIKey_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TenantServiceServer).RegenerateAPIKey(ctx, req.(*RegenerateAPIKeyRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var TenantService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "rag.v1.TenantService",
