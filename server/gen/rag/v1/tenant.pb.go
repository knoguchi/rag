...
type TenantConfig struct {
	...
	RerankerEnabled *bool `protobuf:"varint,7,opt,name=reranker_enabled,json=rerankerEnabled,proto3,oneof" json:"reranker_enabled,omitempty"`
	// Enable hybrid (dense + BM25 sparse) retrieval with RRF fusion.
	// Requires the tenant's vector collection to be hybrid-capable; legacy
	// dense-only collections must be reindexed first.
	HybridEnabled *bool `protobuf:"varint,8,opt,name=hybrid_enabled,json=hybridEnabled,proto3,oneof" json:"hybrid_enabled,omitempty"`
	// Enable contextual retrieval: at ingestion, an LLM generates a short
...
func (x *TenantConfig) GetRerankerEnabled() bool {
	if x != nil && x.RerankerEnabled != nil {
		return *x.RerankerEnabled
	}
	return false
}

func (x *TenantConfig) GetHybridEnabled() bool {
	if x != nil && x.HybridEnabled != nil {
		return *x.HybridEnabled
	}
	return false
}

func (x *TenantConfig) GetContextualRetrievalEnabled() bool {
	if x != nil && x.ContextualRetrievalEnabled != nil {
...
func file_rag_v1_tenant_proto_init() {
	...
	file_rag_v1_tenant_proto_msgTypes[1].OneofWrappers = []any{}
	type x struct{}
